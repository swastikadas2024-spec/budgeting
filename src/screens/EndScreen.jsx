  ...
  return (
    <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="w-full max-w-2xl glass-panel p-6 md:p-8">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="stat-card"><div className="stat-label">💰 Money left</div><div className="stat-value">₹{result.money}</div></div>
        <div className="stat-card"><div className="stat-label">🏦 Savings</div><div className="stat-value">₹{result.savings}</div></div>
        <div className="stat-card"><div className="stat-label">😊 Happiness</div><div className="stat-value">{result.happiness}</div></div>
        <div className="stat-card"><div className="stat-label">⭐ Credit Score</div><div className="stat-value">{result.credit}</div></div>
      </div>
